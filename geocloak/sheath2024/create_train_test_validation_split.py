...
class DataProcessor:
    ...
    def create_splits(self, data, test_intervals, val_years_months):
        ...
        data[initial_timestamp_col] = pd.to_datetime(data[initial_timestamp_col], format='%Y-%m-%dT%H:%M:%S', errors='coerce')
        ...
        for start, end in test_intervals:
            ...
            test_indices = test_indices | ((data[initial_timestamp_col] >= start_date) & (data[initial_timestamp_col] <= end_date))
...
test_intervals = [('2011-08-04', '2011-08-08'), ('2012-07-21', '2012-07-25'), ('2013-03-13', '2013-03-17')]
...
train_set, val_set, test_set = processor.create_splits(data, test_intervals, val_years_months)
