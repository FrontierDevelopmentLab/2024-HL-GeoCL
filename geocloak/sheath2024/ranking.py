...
metric_cols = ['Bt_mae', 'Bt_r2', 'Bt_rmse', 'Bx_mae', 'Bx_r2', 'Bx_rmse',
               'By_mae', 'By_r2', 'By_rmse', 'Bz_mae', 'Bz_r2', 'Bz_rmse',
               'Density_mae', 'Density_r2', 'Density_rmse', 'Speed_mae', 
               'Speed_r2', 'Speed_rmse', 'Temperature_mae', 'Temperature_r2', 
               'Temperature_rmse']
