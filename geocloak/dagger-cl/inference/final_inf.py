...
stages = {
    "stage_1": {
        "model_checkpoint": "../models/model_stage_1.pth",
        "train_loader": dataloader_train_1,
    },
    "stage_2": {
        "model_checkpoint": "../models/model_stage_2.pth",
        "train_loader": dataloader_train_2,
    },
    "stage_3": {
        "model_checkpoint": "../models/model_stage_3.pth",
        "train_loader": dataloader_train_3,
    },
}
...
for stage, data in stages.items():
    ...
    mse_train, rmse_train, mae_train, r2_train = evaluate_model(
        model, data["train_loader"]
    )
