...
class DAGGERStationNet(nn.Module):
    ...
    def __init__(self, input_dim, hidden_dim, output_dim, fc_hidden_dim=512, num_layers=2, dropout_prob=0.3):
    ...
    def forward(self, x):
        ...
        out = self.fc(out[:, -1, :])  # Take the last time step output and pass it through the Sequential block
        return out
