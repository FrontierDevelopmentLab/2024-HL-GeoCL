...
4. If additional station regularization files are needed, run `scripts/station_regularization.py`.
5. Then, for running the parameter sweep, do: `wandb sweep sweep.yaml`, which will give you a sweep_id (actually a command as wandb agent ...)
6. Run the command `wandb agent <sweep_id>`
