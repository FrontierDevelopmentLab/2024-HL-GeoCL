...
if not os.path.exists(os.path.join(output_folder, "scalers.p")):
    supermag_data = SuperMAGIAGADataset(
        *get_iaga_data_as_list(base="data_local/iaga/", year=all_years_list)
    )
    ...
    train_ds_all_years = PreprocessData(
        supermag_data,
        input_data,
        train_idx,
