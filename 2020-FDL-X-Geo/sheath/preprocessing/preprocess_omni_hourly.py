...
times = [pd.to_datetime(ia, unit='D', origin=iv) for ia,iv in zip(Data['DOY'].values,years)]
final_datetime = [t+pd.to_timedelta(h,unit='h') for t,h in zip(times,Data['Hour'].values)]
