...
cloudfetcher_object = CloudFetcher(zarr_bucket="us-fdlx-ard-zarr-synoptic", aia_path = "fdl-sdoml-v2/sdomlv2.zarr",
...
HSE_model.load_model('SHEATH_xgb.model')  # load data
