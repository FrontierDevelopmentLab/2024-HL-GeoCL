...
sdomlsmall = zarr.open(
    "/home/jupyter/Vishal/fdlx/2023-FDL-X-Geo/2020-FDL-X-Geo/sheath/sheath_data/sdoml_data/sdomlv2_small.zarr/2010/193A/"
)
times_193 = pd.to_datetime(sdomlsmall.attrs["T_OBS"])

# Load CH Mask
MASKPATH = "/home/jupyter/Vishal/fdlx/2023-FDL-X-Geo/2020-FDL-X-Geo/sheath/sheath_data/"
ch_mask = np.load(f"{MASKPATH}ar_mask.npy")

# Load SDOML data from v2_small
AIAPATHS = sorted(
    glob(
        "/home/jupyter/Vishal/fdlx/2023-FDL-X-Geo/2020-FDL-X-Geo/sheath/sheath_data/sdoml_data/sdomlv2_small.zarr/2010/*"
    )
)
# Get passbands list
...
CLOSEST_AIA_INDICES = [
    np.argmin(np.abs(TIMES_AIA[IND_193][None, ...] - times[..., None]), axis=0)
...
HMIPATHS = sorted(
    glob(
        "/home/jupyter/Vishal/fdlx/2023-FDL-X-Geo/2020-FDL-X-Geo/sheath/sheath_data/sdoml_data/sdomlv2_hmi_small.zarr/2010/*"
    )
)
...
SAVEPATH = "/home/jupyter/Vishal/fdlx/2023-FDL-X-Geo/2020-FDL-X-Geo/sheath/sheath_data/"
if not os.path.isdir(SAVEPATH):
    os.makedirs(SAVEPATH)

times_aia_save = np.asarray([v.to_numpy() for v in TIMES_AIA[IND_193]])[
    SORTED_INDICES_AIA_193
]
