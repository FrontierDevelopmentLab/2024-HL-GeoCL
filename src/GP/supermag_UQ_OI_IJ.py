...
# start = [2015, 3, 17, 18, 40, 0]  # st. Patricks Day Storm
...
# data_Bn, data_Be, data_Bz, geo_lat, geo_lon = np.zeros(n_stations), np.zeros(n_stations), np.zeros(n_stations), np.zeros(n_stations), np.zeros(n_stations)
#
#
