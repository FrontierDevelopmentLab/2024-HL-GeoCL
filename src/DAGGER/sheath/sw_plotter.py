...
out_feature_names = ["Time", "bx", "by", "bz", "vx", "vy", "vz", "density", "psw", "temperature", "xgse", "ygse", "zgse", "clock_angle"]

for i, ai in enumerate([1,2,3,4,7,9]):
    axes[i].plot(omni_data["index"], omni_data.iloc[:, ai], c="black", label="Actual"*(not i))
