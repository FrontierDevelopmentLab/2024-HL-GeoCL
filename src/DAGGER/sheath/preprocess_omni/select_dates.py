...
taken = np.arange(ind_2011_st,ind_2011_en).astype(int).tolist()+np.arange(ind_2015_st,ind_2015_en).astype(int).tolist()+np.arange(ind_2017_st,ind_2017_en).astype(int).tolist()
...
print(f"Ratios = {len(train_inds)/N:.2f}, {len(val_inds)/N:.2f}, {(len(test_inds)+len(storm_2015)+len(storm_2011)+len(storm_2017))/N:.2f}")

if not os.path.isdir("../logs/"):
    os.makedirs("../logs/")
np.savez("../logs/sheath_train_test_val_split.npz",storm_2015=storm_2015,storm_2017=storm_2017,
