...
def process_supermag_data(data_Bn, data_Be, data_Bz, geo_lat, geo_lon, secs_lat_lon_r, R_earth):
...
def plot_supermag_results(mean_, sd_, pred_lat, pred_lon, n_lat, n_lon, geo_lat, geo_lon, data_Bn, data_Be, lon_sec,
                          lat_sec):
    figs = []
    ...
    pos = ax.contourf(pred_lon[:, :, 0], pred_lat[:, :, 0],
                      ...
                      alpha=0.6, cmap="plasma", transform=ccrs.PlateCarree())
...
# Process the data
mean_, sd_, pred_lat, pred_lon, n_lat, n_lon = process_supermag_data(data_Bn, data_Be, data_Bz, geo_lat, geo_lon, secs_lat_lon_r, R_earth)

# Plot the results and display in Streamlit
figs = plot_supermag_results(mean_, sd_, pred_lat, pred_lon, n_lat, n_lon, geo_lat, geo_lon, data_Bn, data_Be, lon_sec, lat_sec)
